...
// Mon Mar 30 17:20:24 2020 by ROOT version 5.34/34
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_9.root");
      }
      ...
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_0.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_1.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_2.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_3.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_4.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_5.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_6.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_7.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_8.root/data");
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pimP_1.76/Events_3pion_1760/3pion_1760_9.root/data");
      tree = chain;
#endif // SINGLE_TREE
